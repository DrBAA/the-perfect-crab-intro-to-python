...
print("clean ages :", raw_ages)


# filter for even and odd numbers 
print("\nA for loop to filter for even and odd numbers")
...
print("FUNCTION TO CHANGE NEGATIVE NUMBERS INTO POSITIVE NUMBERS")

def turn_numbers_into_positive(list):
  pass
  new_list = []
  for number in list:
    if number < 0:
      ...
      new_list.append(number)
  return new_list
print("turn_numbers_into_positive :", sorted(turn_numbers_into_positive([32, -35, 50, 44, 40, -17, 15, 20, 1, -23])))
